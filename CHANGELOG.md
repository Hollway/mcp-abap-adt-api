...
Этот файл и его английский близнец на ветке `pr/hardening` правятся **вместе**:
что записано здесь, должно быть записано и там, теми же числами и тем же
диапазоном коммитов. Диапазон заканчивается последним содержательным коммитом
версии — коммиты самих этих файлов в него не входят, иначе он не сойдётся
никогда.
