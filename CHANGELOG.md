...
Коммиты `89b2fd1..bf7b395` (11). Инструментов 152 → **162**, тестов 174 → **268**
в 24 наборах, `npm run smoke` — 90 проверок, только чтение.
...
- Запись доменов и текстовых элементов на EMD00 (чтение работает; запись на
  чужой системе не делалась).
